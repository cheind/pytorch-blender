...
A common theme to all of these synthetic approaches is the following: (a) a simulator engine generators supervised artificial data, (b) the generated data is stored to disk and (c) the offline data is used for training. The shortcomings to this process are early training data commitment and the lack of adaptability of data generation to training demands.
